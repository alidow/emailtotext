    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="container mx-auto px-4 py-8 md:py-16 max-w-5xl">
        ...
        <div className="text-center mb-12">
          {/* Illustrative Notice */}
          <div className="bg-amber-50 border-2 border-amber-300 rounded-lg p-4 mb-8 max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-2">
              <AlertCircle className="h-5 w-5 text-amber-600" />
              <h3 className="font-bold text-lg text-amber-900">Documentation Page - For Review Purposes</h3>
            </div>
            <p className="text-amber-800">
              This page is an <strong>illustrative walkthrough</strong> showing how users opt-in to receive SMS messages on our actual website.
              To experience the live opt-in process, please visit{" "}
              <Link href="/" className="text-blue-600 hover:underline font-semibold">
                https://emailtotextnotify.com
              </Link>
              {" "}or{" "}
              <Link href="/get-started" className="text-blue-600 hover:underline font-semibold">
                https://emailtotextnotify.com/get-started
              </Link>
            </p>
          </div>
          ...
          <h1 className="text-4xl font-bold mb-4">SMS Opt-In Process & User Consent Documentation</h1>
          <p className="text-xl text-muted-foreground mb-4">
            Step-by-step documentation of how users sign up and consent to receive text messages on emailtotextnotify.com
          </p>
        ...
        <div className="mb-12">
          ...
          <Card className="overflow-hidden">
            <CardHeader className="bg-gray-50">
              <CardTitle>Step 1: Homepage Phone Entry Form - Email to Text Notifier</CardTitle>
              <CardDescription>
                This shows exactly what users see when they visit https://emailtotextnotify.com (operated by Celestial Platform, LLC)
              </CardDescription>
            </CardHeader>
        ...
        <div className="mb-12">
          ...
          <Card>
            <CardHeader className="bg-gray-50">
              <CardTitle>Step 2: Verification SMS Message from Celestial Platform, LLC</CardTitle>
              <CardDescription>
                This is the exact SMS message users receive with verification code and consent reminder from our toll-free number
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
...
Email to Text Notifier: Your verification code is 123456. By requesting this code, you consent to receive SMS from us at (866) 942-1024. Reply STOP to opt-out. Msg&data rates may apply. Expires in 10 min.
        ...
        <div className="mb-12">
          ...
          <Card>
            <CardHeader className="bg-gray-50">
              <CardTitle>Step 3: Verification Code Entry Page</CardTitle>
              <CardDescription>
                This shows what users see when they enter their code at https://emailtotextnotify.com/verify
              </CardDescription>
            </CardHeader>
            <CardContent className="p-6">
