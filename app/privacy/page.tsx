    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>We collect the following information when you use Email to Text Notifier:</p>
          <ul>
          ...
          <p>We use your information solely to provide the email-to-SMS forwarding service:</p>
          <ul>
          ...
          <p>If you have questions about this privacy policy, please contact us at privacy@emailtotextnotify.com</p>
        </div>
      </div>
    </div>
  )
